<template>
  <div class="m-0 p-0">
    ...
    <div class="hero">
      ...
      <div class="container container-md h-100">
        <div class="row h-100 align-items-center">
          <div class="col-7 col-md-7 hero-content">
            <h1 class="hero-title">
              Your Next
              <span class="hero-title__accent"> IT </span>Specialist is Here
            </h1>
            <p class="hero-subtitle">
              Search and find best IT Specialist from all around the world for
              your one million project idea or business
            </p>
            <button class="itf-btn itf-btn-primary">Discover More</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="container container-md">
          <div class="row">
            <div class="col-12 col-md-12 text-center mb-4">
              <h2 class="itf-section-title-yellow">
    ...
    <div class="container container-md best-spec-container">
      ...
      <div class="row bg-green my-5 find-talent d-flex">
        <div class="col-12 col-md-12 bg-green-55 d-flex specialist-banner">
        ...
        <div class="col-5 col-md-5 d-flex flex-column">
          <div class="next-job">
            ...
            <p>
              ...
              sapiente neque recusandae reiciendis, perspiciatis magnam ducimus
              maxime voluptatibus natus!
            </p>
          </div>
          <div class="next-job">
            <h3 class="krona green-55">Title</h3>
...
.hero {
  ...
  &-img-bg {
    background: url("../../../public/img/hero-img.jpg") no-repeat center center;
