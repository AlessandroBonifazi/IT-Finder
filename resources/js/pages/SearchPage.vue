          ...
          <div class="container h-100">
            <div class="row h-100">
              <div
                ...
                "
              >
                <h1 class="hero-title">Search for best IT Specialists</h1>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="sidebar-body">
              <div class="sidebar-item">
                <div class="sidebar-item-header">
                  <h4 class="sidebar-item-title">Specialization</h4>
                </div>
        ...
        <div class="col-9 m-0 p-0 overflow-hidden">
          ...
          <div class="results-section">
            ...
            <div class="pagination-box">
              <nav aria-label="...">
                <ul class="itf-pagination" v-if="pagination.totalRecords > 12">
                  <li
                    :class="
                      'itf-page-item' +
                    ...
                    <a
                      ...
                      @click="
                        () => {
                          ...
                          getSearch(pagination.currentPage - 1);
                          scrollToTop();
                        }
                      "
                      >Previous</a
                  ...
                  <li
                    :class="
                      'itf-page-item' +
                      (pagination.currentPage === n ? ' active' : '')
                    "
  ...
  methods: {
    ...
    getValutations() {
      window.axios
        ...
        .then((response) => {
          this.valutations = response.data;
          // console.log(response.data);
        })
        .catch((error) => {
          console.log(error);
