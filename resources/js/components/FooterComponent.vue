    ...
    <div class="container-fluid footer">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6 mb-4 mb-lg-0">
                        ...
                        <p class="footer-description">
                            Welcome to the best place where search for Software
                            Developers, Digital Artists, Designers and others It
        ...
        <div class="row">
            <div class="col-md-12 copy">
                <p class="text-center copyright">&copy; Made with &hearts;</p>
            </div>
        </div>
    </div>
</template>
