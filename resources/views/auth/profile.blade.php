                                                ...
                                                <ul class="">
                                                    ...
                                                    <li class=" border-0 px-0 yellow-70">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            ...
                                                            class="bi bi-envelope-fill yellow-70" viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <li class=" border-0 px-0">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor"
                                                            class="bi bi-linkedin yellow-70" viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <li class=" border-0 px-0">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor"
                                                            class="bi bi-github yellow-70" viewBox="0 0 16 16">
                                                            <path
                                                    ...
                                                    <li class="border-0 px-0">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            height="16" fill="currentColor" class="bi bi-globe yellow-70"
                                                            viewBox="0 0 16 16">
                                                            <path
