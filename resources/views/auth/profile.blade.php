                    ...
                    <div class="col-10">
                        ...
                        <div class="itf-card yellow-05">
                            ...
                            <div class="d-flex justify-content-evenly p-3">
                                ...
                                <div class="px-2">
                                    <h5 class="itf-card-title ff-heading yellow-70">{{ $user->name }}
                                        {{ $user->surname }}</h5>
                                    ...
                                    <p class="ff-body">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi quae
                                        odit cumque! Ad perspiciatis neque eos omnis. quasi minima sapiente deleniti impedit
                                        assumenda debitis tempora? Vitae.</p>
                                ...
                                <div class="col-12">
                                    ...
                                    <ul class="d-flex justify-content-around ff-body">
                                        ...
                                        <li class=" border-0 px-0">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-linkedin yellow-70" viewBox="0 0 16 16">
                                                <path
