                ...
                <div class="itf-card-body">
                    ...
                    <div class="row p-3">
                        ...
                        <div class="px-2 col-9">
                            ...
                            @foreach ($specializations as $specialization)
                                <p class="itf-card-subtitle">{{ $specialization->specialization }}</p>
                            @endforeach
                            @if ($user->cv)
                                <p class="itf-card-text">{{ $user->cv }}</p>
                            @endif
                        </div>
                    </div>
                    {{-- Tech Stack --}}
                        ...
                        <div class="col-12">
                            ...
                            @if ($techs->count() > 0)
                                @foreach ($techs as $tech)
                                    <img src="{{ $tech->logo }}" alt="" class="tech-logo" />
                                @endforeach
                            @else
                                <p class="itf-card-text">
                                    No technologies yet.
                                </p>
                            @endif
                            {{-- /Tech stack user --}}
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <ul class="">
                                    {{-- Email --}}
                                    <li>
                                        <a class=" navigation-link" href="mailto:{{ $user->contactInfo->contact_email }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                                                <path
                                                    d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z" />
                                            </svg>
                                            {{ $user->contactInfo->contact_email }}</a>

                                    </li>
                                    {{-- /Email --}}
                                    {{-- Linkedin --}}
                                    <li class=" navigation-link">
                                        <a href="{{ $user->contactInfo->linkedin }}" class="navigation-link">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    {{-- Github --}}
                                    <li>
                                        <a href="{{ $user->contactInfo->github }}" class="navigation-link">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    {{-- Site --}}
                                    <li>
                                        <a href="{{ $user->contactInfo->site }}" class="navigation-link">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="row">
                        <div class="col-12 card-body d-flex">
                            ...
                            <a class="itf-btn itf-btn-primary mr-2" href="{{ route('user.edit', $user->id) }}">Edit
                                Profile</a>
                            {{-- </button> --}}
                            {{-- Delete --}}
                            <form action="{{ route('user.destroy', $user->id) }}" method="post">
                                ...
                                @method('DELETE')
                                <button type='submit'
                                    onclick="return confirm('Are you sure you want to delete your account?')" type="submit"
                                    value="" class="itf-btn itf-btn-secondary">
                                    Delete Account
                                </button>
                            </form>
                        </div>
