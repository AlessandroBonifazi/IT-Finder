...
@section('content')
    ...
    <div class="row p-3 justify-content-center offset-0">
        @if($user->contactInfo)
        <div class="col-sm-10 col-md-10 col-lg-9">
            <div class="row d-flex ">
                <div class="col-10">
                    <div class="row">
                        <div class="col-12 ff-body yellow-95">
                            <h5>Details Profile</h5>
                        </div>
                    </div>

                    <div class="itf-card yellow-05">
                        {{-- img --}}
                        <div class="d-flex justify-content-evenly p-3">
                            <div class="w-100">
                                <img src="/img/img-placeholder.png" class=" rounded-circle img-fluid w-100"
                                alt="profile-img">
                            </div>

                                <div class="px-2">
                                    <h5 class="itf-card-title ff-heading yellow-70">{{ $user->name }} {{ $user->surname }}</h5>
                                ...
                                <p class="yellow-70 ff-body">{{ $specialization->specialization }}</p>
                                     ...
                                     <p class="ff-body">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quasi quae odit cumque! Ad perspiciatis neque eos omnis.  quasi minima sapiente deleniti impedit assumenda debitis tempora? Vitae.</p>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-body ff-body">
                                    ...
                                    {{$tech->name}}
                                    <img src="{{ asset('storage/' . $tech->logo)}}" alt="" class="h-100"/>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-body ff-heading yellow-70">
                                    <h4>
                                        Contacts
                                    </h4>
                                </div>
                                    <ul class="d-flex justify-content-around ff-body">
                                    {{--Email--}}
                                            <li class=" border-0 px-0 yellow-70">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill yellow-70" viewBox="0 0 16 16">
                                    ...
                                    {{--Linkedin--}}
                                             <li class=" border-0 px-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin yellow-70" viewBox="0 0 16 16">
                                                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
                                                  </svg>
                                                    <a href="" class="text-decoration-none yellow-70 ">
                                    ...
                                    {{--Github--}}
                                            <li class=" border-0 px-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-github yellow-70" viewBox="0 0 16 16">
                                    ...
                                    {{--Site--}}
                                            <li class="border-0 px-0">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe yellow-70" viewBox="0 0 16 16">
                        ...
                        <div class="row">
                            <div class="col-12 card-body d-flex">
                                <button class=" itf-btn itf-btn-primary ff-body mx-2">
                                    <a class="text-decoration-none text-white p-2" href="{{ route('user.edit', $user->id) }}">Edit Profile</a>
                                </button>
                                {{-- Delete --}}
                                <form action="{{ route('user.destroy', $user->id) }}" method="post">
                                    ...
                                    <button type='submit' onclick="return confirm('Are you sure you want to delete your account?')"
                                        type="submit" value="" class="itf-btn itf-btn-secondary ff-body">
                                        Delete Account
                                    </button>
                                </form>
                            </div>
